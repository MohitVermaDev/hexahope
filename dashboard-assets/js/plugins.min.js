...
defaultMenuCollapse(), $(window).on("load", function () {
	...
	var n = document.querySelectorAll(".collapsible");
	M.Collapsible.init(n);
	var a = document.querySelector(".collapsible.expandable");
	M.Collapsible.init(a, {
		accordion: !1
	});
	if (breadcrumbsWrapper.attr("data-image")) {
		var l = breadcrumbsWrapper.attr("data-image");
		breadcrumbsWrapper.addClass("breadcrumbs-bg-image"), breadcrumbsWrapper.css("background-image", "url(" + l + ")")
	}
	var t, o = $("li.active .collapsible-sub .collapsible"),
		i = document.querySelectorAll(".sidenav-main .collapsible");
	if (M.Collapsible.init(i, {
			accordion: !0,
	...
	if (0 < o.find("a.active").length && (o.find("a.active").closest("div.collapsible-body").show(), o.find("a.active").closest("div.collapsible-body").closest("li").addClass("active")), t = 0 < $(".sidenav-main li a.active").parent("li.active").parent("ul.collapsible-sub").length ? $(".sidenav-main li a.active").parent("li.active").parent("ul.collapsible-sub").position() : $(".sidenav-main li a.active").parent("li.active").position(), setTimeout(function () {
			...
			edge: "right"
		}), 0 < $("#slide-out.leftside-navigation").length && !$("#slide-out.leftside-navigation").hasClass("native-scroll")) new PerfectScrollbar(".leftside-navigation", {
		wheelSpeed: 2,
		wheelPropagation: !1,
	...
	if (0 < $("#ul-horizontal-nav").length) var d = new PerfectScrollbar("#ul-horizontal-nav", {
		wheelPropagation: !1
	});
